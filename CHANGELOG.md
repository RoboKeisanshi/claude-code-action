...
## Fork Changes (RoboKeisanshi/claude-code-action@beta)
...
- **Updated Base Action**: Uses `RoboKeisanshi/claude-code-base-action@beta` which includes OAuth credential handling
